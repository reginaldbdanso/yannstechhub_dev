...
export const SecureCheckout: React.FC = () => {
  return (
    <main className="pb-4 bg-white">
      <div className="flex flex-col pt-5 pb-24 w-full bg-gray-100 max-md:max-w-full">
        {/* <NavigationBar /> */}
        <hr className="mt-7 w-full border border-solid border-neutral-300 min-h-px mt-[100px]" />
        <BreadcrumbNav />
        <hr className="mt-3 w-full border border-solid border-neutral-300 min-h-px" />

        <section className="self-center mt-10 ml-6 w-full max-w-[1158px] max-md:max-w-full">
