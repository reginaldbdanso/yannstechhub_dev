          ...
          <img src="imgs/Profile - 3.png" alt="User Account" class="action-icon" />
                    ...
                    <div class="cart-container">
                        ...
                        <div class="subtotal-container" id="subtotal-container">
                            ...
                            <div class="subtotal-amount">$<span id="subtotal">0.00</span></div>
                        </div>
                        <div class="checkout-divider"></div>
                        <div class="tax-shipping-info">Tax included and shipping calculated at checkout</div>
                        <div class="checkout-button" tabindex="0" role="button"><a href="secure-checkout.html">Proceed to checkout</a></div>
                    </div>
                </div>
...
function updateSubtotal() {
        ...
        totalElements.forEach(el => {
          let price = parseFloat(el.innerText.replace('$', '').trim());
          subtotal += price;
        });
