...
import '../styles/components/Legal_module.css';
  ...
  return (
    <div className="legalPage">
      ...
      <main className="mainContent">
        <h1 className="legalTitle">Legal Overview</h1>
        ...
        <section className="policySection">
          <h2 className="sectionTitle">1. Privacy Policy</h2>
        ...
        <section className="policySection">
          <h2 className="sectionTitle">2. Terms of Service</h2>
        ...
        <section className="policySection">
          <h2 className="sectionTitle">3. Refund and Returns Policy</h2>
